...
public class TradingParameters  implements Serializable {
    ...
    public static org.slf4j.Logger getLogger() {return logger;}

    public static OpenApi getApi() {return  api;}

    public static RoborPortfolio getPortfolio() {return portfolio;}
    ...
    public void open() throws IOException, ClassNotFoundException {
      ...
      try (ObjectInputStream objectInputStream = new ObjectInputStream(
          ...
          if ((ssoKey == null)) { throw new NullPointerException("Не указан ключ. выполнение не возможно"); }
